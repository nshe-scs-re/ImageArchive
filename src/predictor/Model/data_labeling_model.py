...
# Only run the training code if this file is executed directly
if __name__ == "__main__":
    # Define paths
    dataset_path = "/home/nmichelotti/Desktop/Senior Model/my_data"
    ...
    assert torch.cuda.is_available(), "CUDA is not available — cannot run on GPU."
